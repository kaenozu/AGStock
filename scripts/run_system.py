        ...
        while True:
            ...
            if now.minute != last_run_minute:
                ...
                if current_time == "08:00" and weekday < 5:
                    run_script(
                        "morning_dashboard.py", "朝活ブリーフィング"
                    )  # morning_brief.py か morning_dashboard.py か確認が必要だが、dashboardの方が包括的か？ morning_brief.pyを確認する
...
def test_system():
    ...
    # 1. ファイル存在確認
    required_files = ["unified_dashboard.py", "morning_dashboard.py", "fully_automated_trader.py", "weekend_advisor.py"]
