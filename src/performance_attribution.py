...
class PerformanceAttribution:
    ...
    def timing_vs_selection(self,
        ...
        return {
            ...
            'information_ratio': excess_return / (portfolio_ret - benchmark_ret).std() / np.sqrt(252) if (portfolio_ret - benchmark_ret).std() > 0 else 0
        }
