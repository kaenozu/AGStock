...
class NewsShockDefense:
    ...
    CRITICAL_KEYWORDS = {
        ...
        "ECONOMIC_SHOCK": ["暴落", "連鎖倒産", "デフォルト", "CRASH", "BANKRUPTCY", "DEFAULT"],
        "PANDEMIC": ["パンデミック", "緊急事態宣言", "ロックダウン", "PANDEMIC", "LOCKDOWN"],
        "POLICY_SHOCK": ["想定外の利上げ", "緊急利上げ", "財務相辞任", "UNEXPECTED RATE HIKE"]
    }
