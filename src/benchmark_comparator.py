...
class BenchmarkComparator:
    ...
    def calculate_active_return(self, portfolio_returns: pd.Series,
    ...
    def generate_comparison_report(self, portfolio_returns: pd.Series,
                                  benchmark_name: str = 'nikkei225') -> Dict:
        """
        包括的な比較レポートを生成
