...
class OptionStrategy:
    ...
    @staticmethod
    def covered_call(stock_price: float, stock_quantity: int,
                    call_strike: float, call_premium: float) -> Dict:
        """
        カバードコール戦略
    ...
    @staticmethod
    def protective_put(stock_price: float, stock_quantity: int,
                      put_strike: float, put_premium: float) -> Dict:
        """
        プロテクティブプット戦略
