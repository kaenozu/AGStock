        ...
        try:
            ...
            if len(recent_returns) > 0:
                ...
                for i in range(prediction_days):
                    ...
                    volatility_factor = max(0.5, min(2.0, enhanced_data['Close'].rolling(20).std().iloc[-1] / enhanced_data['Close'].iloc[-1] * 1000 + 1)) if len(enhanced_data) >= 20 else 1.0
            ...
            return {
                ...
                "features_used": [col for col in enhanced_data.columns if col.startswith(('SPY_', 'US_', 'VIX_', 'Risk_'))]
            }
