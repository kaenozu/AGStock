...
class FilingWatcher:
    ...
    def __init__(self, watch_dir: str = "./data/new_filings", processed_dir: str = "./data/processed_filings"):
        ...
        for filename in files:
            ...
            try:
                ...
                if analysis_result:
                    ...
                    # 4. 移動（処理済みへ）
                    dest_path = os.path.join(self.processed_dir, f"{datetime.now().strftime('%Y%m%d_%H%M%S')}_{filename}")
