...
def _show_portfolio_summary():
    ...
    try:
        ...
        with col3:
            st.metric("評価損益", format_currency_jp(balance['unrealized_pnl']), 
        ...
        if not positions.empty:
            ...
            # 列名を日本語に変換して表示
            display_df = positions_display[['ticker', 'company_name', 'quantity', 'current_price', 
                                          '保有額', '評価損益', '評価損益率']].copy()
