...
from src.constants import NIKKEI_225_TICKERS, SP500_TICKERS, STOXX50_TICKERS, CRYPTO_PAIRS, FX_PAIRS
...
class AssetSelector:
    ...
    def get_target_tickers(self) -> List[str]:
        ...
        self.logger.info(f"現在の資産配分: 日本{japan_pct:.1f}% 米国{us_pct:.1f}% 欧州{europe_pct:.1f}% Crypto{crypto_pct:.1f}% FX{fx_pct:.1f}%")
