...
class HedgingManager:
    ...
    HEDGE_TARGETS = {
        "JP": [
            {"ticker": "1357.T", "name": "NF日経ダブルインバース", "type": "Inverse ETF"},
            {"ticker": "1360.T", "name": "楽天日経ダブルインバース", "type": "Inverse ETF"}
        ],
        "US": [
    ...
    def apply_hedging_logic_to_decision(self, ticker: str, original_decision: TradingDecision, macro_data: Dict[str, Any]) -> TradingDecision:
        """
