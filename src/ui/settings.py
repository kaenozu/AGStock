...
def _render_advanced_view():
    ...
    with tab1:
        ...
        display_openai = current_openai_key[:7] + "..." + current_openai_key[-4:] if len(current_openai_key) > 12 else ""
        ...
        display_gemini = current_gemini_key[:6] + "..." + current_gemini_key[-4:] if len(current_gemini_key) > 10 else ""
