...
class PortfolioManager:
    ...
    def simulate_portfolio(self, data_map: Dict[str, pd.DataFrame], strategies: Dict[str, Strategy], weights: Dict[str, float], **kwargs) -> Dict[str, Any]:
        """
        ...
        bt = Backtester(initial_capital=self.initial_capital, commission=self.commission, slippage=self.slippage, position_size=weights)
