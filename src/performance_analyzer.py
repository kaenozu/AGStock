...
class PerformanceAnalyzer:
    ...
    def compare_to_benchmark(self, benchmark_ticker: str = "^N225") -> Dict:
        ...
        try:
            ...
            # 自分のリターン
            my_return = (equity_history.iloc[-1]['total_equity'] - equity_history.iloc[0]['total_equity']) / equity_history.iloc[0]['total_equity']
    ...
    def get_strategy_performance(self) -> pd.DataFrame:
        ...
        # 戦略別に集計
        strategy_stats = trade_history.groupby('strategy').agg({
