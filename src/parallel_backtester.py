...
class ParallelBacktester:
    ...
    @staticmethod
    def _run_single_backtest(ticker: str, 
                            strategy, 
                            data: pd.DataFrame,
                            params: Dict) -> Dict:
        """
    ...
    def run_walk_forward_parallel(self,
                                  tickers: List[str],
                                  strategy,
                                  data_map: Dict[str, pd.DataFrame],
                                  train_size: int = 252,
    ...
    @staticmethod
    def _run_walk_forward_window(ticker: str,
                                 strategy,
...
def benchmark_backtest_speed():
    ...
    results_parallel = backtester.run_parallel_backtest(
        tickers, strategies, data_map
    )
