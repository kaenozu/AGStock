...
class ResultAggregator:
    ...
    def aggregate_position_history(self, 
    ...
    def aggregate_portfolio_history(self, 
    ...
    def aggregate_signal_statistics(self, 
                                  signals: Dict[str, pd.Series],
                                  ticker: str = None) -> Dict[str, int]:
        """シグナルの統計を集計
    ...
    def generate_summary_report(self, 
                              ...
                              signals_stats: Dict[str, int] = None) -> Dict[str, Any]:
        """要約レポートを生成
        ...
        portfolio_stats = {
            ...
            'max_portfolio_value': portfolio_df['portfolio_value'].max() if 'portfolio_value' in portfolio_df.columns else 0.0,
            'min_portfolio_value': portfolio_df['portfolio_value'].min() if 'portfolio_value' in portfolio_df.columns else 0.0,
