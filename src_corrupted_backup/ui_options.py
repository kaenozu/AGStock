...
#                 fig.add_vline(x=strike_price, line_dash="dash", line_color="red", annotation_text="行使価格")
#                 fig.update_layout(
#                     title=f"{option_type}オプション ペイオフ図", xaxis_title="株価", yaxis_title="損益", height=400
#                 )
