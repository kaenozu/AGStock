...
# Lazy load chromadb and langchain
...
try:
        ...
        except (ValueError, Exception) as e:  # ChromaDB might raise various exceptions
            logger.info(f"Creating new collection (Reason: {e})")
            self.collection = self.client.create_collection(
                name="earnings_reports", metadata={"description": "Earnings reports vector store"}
            )
