...
#         return signals_map
#     def _calculate_portfolio_value(self, cash, holdings, aligned_data, index, entry_prices, final_calc=False):
    pass
#         """ポートフォリオ価値を計算"""
...
#         self, today_sig, ticker, holdings, entry_prices, exec_price, trades, cash, exit_executed, full_index, i
#     ):
    pass
#         """整数信号の処理"""
#         position = holdings[ticker]
