...
self.regime_weights["ranging"] = {"LGBMPredictor": 0.5, "ProphetPredictor": 0.3, "TransformerPredictor": 0.2}
...
#     """
def predict(self, X: pd.DataFrame, regime: Optional[str] = None, return_individual: bool = False) -> np.ndarray:
        pass
#         """
