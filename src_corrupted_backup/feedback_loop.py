...
try:
            ...
            if history.empty:
                return {"total_trades": 0, "win_rate": 0.0, "daily_pnl": 0.0, "avg_profit": 0.0, "avg_loss": 0.0}
...
journal_dir = "data/journals"
        ...
        journal_path = f"{journal_dir}/journal_{datetime.now().strftime('%Y%m%d')}.txt"
            ...
            return {"metrics": metrics, "adjustments": adjustments, "journal": journal, "journal_path": journal_path}
