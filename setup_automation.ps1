...
# 3. AIモーニング・ブリーフィング (平日 08:50)
$BriefTask = "AGStock_MorningBriefing"
$BriefAction = New-ScheduledTaskAction -Execute $PythonExe -Argument "$BaseDir\scripts\morning_briefing.py" -WorkingDirectory $BaseDir
$BriefTrigger = New-ScheduledTaskTrigger -Daily -At 08:50
...
Register-Task $BriefTask $BriefAction $BriefTrigger
