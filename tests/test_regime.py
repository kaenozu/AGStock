...
def sample_macro_data():
    ...
    vix_data = pd.DataFrame({"Close": np.random.uniform(15, 30, 200)}, index=dates)

    sp500_data = pd.DataFrame({"Close": np.linspace(4000, 4500, 200) + np.random.normal(0, 50, 200)}, index=dates)

    us10y_data = pd.DataFrame({"Close": np.random.uniform(3.5, 4.5, 200)}, index=dates)

    us02y_data = pd.DataFrame({"Close": np.random.uniform(4.0, 5.0, 200)}, index=dates)

    gold_data = pd.DataFrame({"Close": np.random.uniform(1800, 2000, 200)}, index=dates)

    return {"VIX": vix_data, "SP500": sp500_data, "US10Y": us10y_data, "US02Y": us02y_data, "GOLD": gold_data}
