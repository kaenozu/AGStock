...
class TestExecution(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_paper_trader.get_current_balance.return_value = {"cash": 1000000.0, "total_equity": 1000000.0}
    ...
    def test_position_size_min_order(self):
        ...
        self.mock_paper_trader.get_current_balance.return_value = {"cash": 1000.0, "total_equity": 1000.0}
