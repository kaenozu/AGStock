...
class SetupWizard:
    ...
    def step2_capital(self, experience: str):
        ...
        capital = self.get_number(
            "💰 初期資金 (円)",
            default=default_capital[experience],
            min_val=100000
        )
    ...
    def generate_config(self, experience: str, capital: int, risk: str, 
                       notifications: Dict, automation: Dict) -> Dict:
        """設定を生成"""
